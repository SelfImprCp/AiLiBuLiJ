 ...
 *
 */
public class HomeFragment extends BaseListFragment<ShangQuanBean> {
    ...
    protected void sendRequestData() {
        ...
        LogCp.i(LogCp.CP ,HomeFragment.class + " 当前加的是第几页 ：" + mCurrentPage);
        MoFoxApi.getMainFocusList(mCurrentPage + "",  "76" + "", mHandler);
