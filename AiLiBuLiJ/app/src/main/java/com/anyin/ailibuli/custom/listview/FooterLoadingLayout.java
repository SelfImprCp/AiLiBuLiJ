 ...
 */
package com.anyin.ailibuli.custom.listview;
...
public class FooterLoadingLayout extends LoadingLayout {
	...
	private void init(Context context) {
		...
		strRefreshing = context
				.getString(R.string.pushmsg_center_load_more_ongoing_text);
		strReleaseToRefresh = context
				.getString(R.string.pushmsg_center_pull_release_text);
		strPullToRefresh = context
				.getString(R.string.pushmsg_center_pull_down_text);
	}
