...
public class MyHorizontalScrollView extends HorizontalScrollView implements
	 ...
	 * 
	 */
	public interface HSOnItemClickListener {
		void onClick(View view, int pos);
	}

	private CurrentImageChangeListener mListener;

	private HSOnItemClickListener mOnClickListener;
	...
	public void initDatas(BaseAdapter mAdapter) {
		...
		if (mChildWidth == 0 && mChildHeight == 0) {
			...
			Log.e(TAG, "mCountOneScreen = " + mCountOneScreen
					+ " ,mChildWidth = " + mChildWidth + "mAdapter.getCount() :" + mAdapter.getCount());
	...
	public void setOnItemClickListener(HSOnItemClickListener mOnClickListener) {
