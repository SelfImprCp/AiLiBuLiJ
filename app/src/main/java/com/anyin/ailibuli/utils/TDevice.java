...
public class TDevice {
	...
	*/
	...
	public static boolean hasBigScreen() {
		...
		if (_hasBigScreen == null) {
			boolean flag1;
			if ((0xf & AppContext.getInstance() .getResources()
	...
	public static final boolean hasCamera() {
		if (_hasCamera == null) {
			PackageManager pckMgr =  AppContext.getInstance()
					.getPackageManager();
			boolean flag = pckMgr
    ...
    */
	...
	public static String getCurCountryLan() {
		return  AppContext.getInstance().getResources().getConfiguration().locale
				.getLanguage()
				+ "-"
				+  AppContext.getInstance().getResources().getConfiguration().locale
						.getCountry();
	}

	public static boolean isZhCN() {
		String lang =  AppContext.getInstance().getResources()
